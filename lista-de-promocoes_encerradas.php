...
$ofertalista = $objOferta->listarOferta3($filtro." and ativa = 0 ");
/*var_dump($ofertalista);die;*/
...
<div class="promo-lista">
  ...
  <div class="text-promo-lateral">
  	<?php $titulosemspan = str_replace("[span]","",$dados['titulo']);
  	 	  ...
  	 	  $titulosemspan = $objOferta->anti_injection($titulosemspan);
  	echo substr($titulosemspan,0,80)."..."?>
  </div>
  <div class="btn-encerrado-menor"><a href="#"></a></div>
