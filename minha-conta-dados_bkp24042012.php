...
<input tabindex="1" name="nome" id="nome" type="text" class="textfield" value="<?php echo $cliente["nome"]; ?>"/></td>
    <td><legend>Como quer ser chamado ?</legend>
<input tabindex="2" name="nome2" id="nome2" type="text" class="textfield" value="<?php echo $cliente["apelido"]; ?>"/></td>
  </tr>
  <tr>
...
<input tabindex="4" name="data-nascimento" id="data-nascimento" type="text" class="textfield"/></td>
  ...
  <tr>
    ...
    <td><div class="btn-atualizar"></div></td>
  </tr>
</table>
 </form> <br />
<br />
...
<input name="novasenha" id="novasenha" type="password" class="textfield"/></td>
