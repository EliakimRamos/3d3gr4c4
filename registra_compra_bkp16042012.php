...
class createPaymentRequest {
	...
	public static function main () {
		...
		$paymentRequest->addItem($oferta['id']." ".$venda['id_cliente']." ".$utimoid,substr($titulo,0,100), $quantidade,number_format($oferta['valorpromocao'],2,".",""));
		...
		$nome = str_replace("[span]","",utf8_decode($resCliente['nome']));
		$nome = str_replace("[/span]","",$nome);
		$paymentRequest->setSender($nome, $resCliente['email']);
