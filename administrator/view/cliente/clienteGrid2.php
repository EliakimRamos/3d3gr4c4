			...
			<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
	    		<thead>
					<tr>		
						...
						<td class="topoTabela"><strong>Ação</strong></td>
					</tr>
				</thead>
				<tbody>
 					<?php 
    				...
    				<tr class="gradeA">
      					...
      					<td align="left"><?php echo ucwords(strtolower($dados['nome']));?></td>
					  ...
					  <td>			
				  			<a href="?pac=cliente&tela=clienteForm&op=Editar&i=<?php echo $dados['id'];?>" id="edit">
				  				<img title="Editar" src="img/editar.png" width="15" height="17" border="0"></a> 
				  	  </td>
			  	  </tr>
   				<?php } } ?>
   			</tbody>
