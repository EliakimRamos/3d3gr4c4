...
$nome = $_POST['nome'];
$sql = "select * from comercial where nome like '%".utf8_decode($nome)."%' order by nome";
...
<table class="table">
	...
	<tr>
		...
		<td>
			<a	href="?pac=comercial&tela=comercialForm&op=Editar&i=<?php echo $dados['id'];?>" id="edit"> <img title="Editar" src="img/editar.png" width="31"
				height="35" border="0"> 
			</a>			
		</td>
	</tr>
