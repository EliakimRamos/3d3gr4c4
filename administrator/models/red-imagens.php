...
class OBImagem 
{
	...
	{   
		if(!strstr($origem,"http") && !file_exists($origem) || file_exists($destino))
		{
			//echo("Arquivo de origem da imagem inexistente");
			return false;
		}
...
//$OBImagem->redimensiona("./img_real.jpg","./img.jpg",400,400,75);
//$OBImagem->redimensiona_fixo("./img_real.jpg","./img_peq.jpg",107,80,60);		
