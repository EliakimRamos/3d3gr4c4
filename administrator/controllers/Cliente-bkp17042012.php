		...
		switch ($_POST['op']) {
			case 'Inserir':
				if($_SESSION['captcha'] != $_POST['captcha']){
					$_SESSION['alert'] = utf8_encode("Cï¿½digo de Seguranï¿½a Invï¿½lido");
					...
					if(mysql_num_rows($query) == 0){
						...
						$_SESSION['alert'] = utf8_encode("E-mail utilizado por outro Usuï¿½rio");
					...
					if($retorno){
						...
						$_SESSION['alert'] = utf8_encode("Problemas na inserï¿½ï¿½o");
						if($_SESSION['administrador']){
							//header("Location: ../index.php?pac=".$pacote."&tela=".$tela."Form&op=Inserir");
							?>
						 <script language="JavaScript" type="text/javascript">
			...
			case 'Editar':
				...
				if(mysql_num_rows($query) == 0){
					...
					$_SESSION['alert'] = "Problemas na ediï¿½ï¿½o: Email utilizado por outro usuï¿½rio";
					if($_SESSION['administrador']){
				...
				if($retorno){
					...
					$_SESSION['alert'] = "Problemas na ediï¿½ï¿½o";
					if($_SESSION['administrador']){
						//header("Location: ../index.php?pac=".$pacote."&tela=".$tela."Form&op=Editar&i=".$_POST['id']);
						?>
						 <script language="JavaScript" type="text/javascript">
