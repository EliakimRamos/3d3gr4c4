...
$Novato = false;
	...
	if($objOferta->anti_injection($_GET['id'])){
		$id = $objOferta->anti_injection($objOferta->anti_injection($_GET['id']));
...
<div id="main-left">
    ...
    <div id="container-left">
     ...
     <div class="fb-like" data-href="http://www.facebook.com/Sodapoplive" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>-->
...
<?php
		if ($empresa['num']!="0"){
		$endMapa=utf8_encode($empresa['endereco'].",".$empresa['num'].",".$empresa['bairro'].",".$empresa['cidade'].",PE,".$empresa['cep']);
