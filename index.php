...
$Novato = false;
	...
	if($objOferta->anti_injection($_GET['id'])){
		...
		if(empty($oferta) || $oferta['ativa'] == 0){	
			//header("Location: index.php");
			echo"<meta http-equiv='refresh' content='1;URL=http://www.edegraca.com.br/index.php'>"; 
		die;
		}
	}else{
		if(empty($idCidade)){
		...
		$oferta = $aux[0];
			...
			$filtro = $idCidade." and o.data_final > ".$datahoje." and o.ativa = 1 ";
			$aux = $objOferta->listarOferta3($filtro);
			$oferta = $aux[0];
		}	
	}		
...
if(empty($oferta)){
	//echo"<meta http-equiv='refresh' content='1;URL=http://www.edegraca.com.br/cadastro.php'>"; 
		if($oferta['ativa'] == 0){
	@header("location:./index.php");
...
<meta http-equiv='refresh' content='180;URL=http://www.edegraca.com.br/'>
...
$(document).ready(function() {
	...
	<?php if(empty($_SESSION['jaabril'])){ ?>		
	
			
			$('.fancybox').fancybox();
			$.fancybox.open([
        	{
            href : '#modal', width: 800              
            
        	}   	
    		]);
    <?php 
    	$_SESSION['jaabril'] = "true";
    } ?>
...
$(function(){
	$("#cod_estados").change(function(){
		$.post("getcidades.php",{cod_estado:$("#cod_estados").val()},
		      function(data){
...
<div id="main-left">
    ...
    <div id="container-left">
       ...
       <div class="btn-comprar"><a href="<?php if($oferta['id'] != '137'){?>tela-comprar.php?oferta=<?php echo $oferta['id']; ?><?php }else{?>tela-comprar-agendar.php?oferta=<?php echo $oferta['id']; ?><?php }?>"></a>	</div>
     ...
     <div class="fb-like" data-href="http://www.facebook.com/edegraca.com.br" data-send="false" data-layout="button_count" data-width="180" data-show-faces="false"></div>
    ...
    <div class="contorno-col-2"><h2 class="tit-desc"> Regras: </h2> 
    ...
    <h2> Informa&ccedil;&otilde;es:</h2>
     <strong><?php echo nl2br($empresa['nome_fantasia'])?></strong> <br/>
...
?> 
    ...
    <div class="contorno-meio">
    	<h2>Localização:</h2>
        <iframe width="731" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo $empresa['mapa']; ?>"></iframe><br /></div>
