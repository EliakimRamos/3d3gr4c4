...
<script>
 ...
 $("#cidade-fechar").click(function(){
	 $("#cidades").slideUp("slow");
	 })
 $("#cidades-topo").click(function(){
	if ($("#cidades").is(":hidden")) {
		$("#cidades").slideDown("slow");
	} else {
		$("#cidades").slideUp("slow");
		}
...
<div id="cidades">
<div id="cidade-wrap">
<div id="cidade-fechar"></div>
<ul>
<li><a href="#">Recife</a></li>
<li><a href="#">Rio de Janeiros</a></li>
<li><a href="#">São Paulo</a></li>
<li><a href="#">Teresina</a></li>
